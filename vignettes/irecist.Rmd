---
title: "Creating iRECIST"
output: 
  rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Creating iRECIST}
...
This article describes creating an `iRECIST` oncology
endpoint parameters based on iRECIST criteria in ADRS. Therefore response values are
expected as either `iCR`, `iPR`, `iSD`, `NON-iCR/NON-iPD`, `iUPD`,'icPD' or `NE`.
